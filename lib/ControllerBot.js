...
module.exports = class {
                        ...
                        for (const ri of r) {
                            try {
                                ...
                                if (message && "msg" in message && message.msg.constructor.name === 'String') {
                                    ...
                                    this.msgHandler(group.gid, ri);
                                } else {
                                    log2.error("Invalid error message:", ri);
                                }
                            } catch(err) {
  ...
  updatePrimaryDeviceName(name) {
    ...
    async txData(gid, msg, obj, type, beepmsg, whisper, callback, rawmsg) {
    ...
    recordTracelog(rawmsg, obj) {
      try {
        ...
        log2.error("RecordTracelog error", e, rawmsg, obj);
      }
    }
