...
exports.checkin = function (config,info, callback) {
    console.log("Checkin");
    let obj = {
...
exports.log = function (cmd, obj, callback) {
    console.log("/device/log/" + cmd, obj);
    var options = {
...
exports.intel = function (ip, action, obj, callback) {
    console.log("/intel/host/" + ip + "/" + action, obj);
    var options = {
...
exports.flowgraph = function (action, obj, callback) {
    console.log("/flowgraph/" + action, JSON.stringify(obj));
    var options = {
