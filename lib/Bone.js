...
exports.logAsync = async function (cmd, obj) {
  ...
  try {
    ...
    log.error("Error sending bone log", err)
  }
}
...
exports.intel = function(ip, action, intel, callback) {
...
exports.hashsetAsync = async function (hashsetid) {
  ...
  if (response.statusCode < 200 ||
    ...
    log.error("**** Error while response HTTP hashset", response.statusCode);
...
exports.submitIntelFeedback = function (action, intel) {
