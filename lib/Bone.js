...
exports.submitUserIntel = function (action, intel) {
  ...
  let __value = querystring.escape(_value);

  log.info("Type:", type, ", Original value:", value, ", Hashed value:", _value, ", Escaped Hashed value:", __value, {});

  exports.intel(type, __value, action, intel, (err) => {
    if (err) {
