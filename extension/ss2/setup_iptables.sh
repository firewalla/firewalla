...
sudo iptables -w -t nat -A $FW_SS_CHAIN --match-set $FW_SS2_WHITE_LIST dst -j RETURN
sudo iptables -w -t nat -A $FW_SS_CHAIN --match-set $FW_SS2_WHITE_LIST_NET dst -j RETURN
