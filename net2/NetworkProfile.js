...
class NetworkProfile {
  ...
  async createEnv() {
    ...
    const inputRuleSec = new Rule().chn("FW_INPUT_DROP").mth(realIntf, null, "iif").mdl("conntrack", "--ctstate NEW").mdl("conntrack", "! --ctstate DNAT").jmp("FW_SEC_DROP").mdl("comment", `--comment ${this.o.uuid}`);
