...
async createEnv() {
    ...
    const inputRule = new Rule().chn("FW_INPUT_DROP").pro("tcp").mth(realIntf, null, "iif").mdl("conntrack", "--ctstate NEW").mdl("conntrack", "! --ctstate DNAT").jmp("DROP").mdl("comment", `--comment ${this.o.uuid}`);
