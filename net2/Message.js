...
const MSG_BLOCK_FLOW_STATS_UPDATE = "BLOCK_FLOW_STATS_UPDATE";
// fired in FireMain when an event is persisted into event:log, see EventRequestHandler.sendEvent
const MSG_EVENT_GENERATED = "EVENT_GENERATED";
