  ...
  processConnData(data) {
    try {
      ...
      if (obj.proto == "tcp" && (obj.orig_bytes == 0 || obj.resp_bytes == 0)) {
        if (obj.conn_state=="REJ" || obj.conn_state=="S1" || obj.conn_state=="S2" || obj.conn_state=="S3" ||
          obj.conn_state=="RSTOS0" || obj.conn_state=="RSTRH" || obj.conn_state=="RSTO" || obj.conn_state=="RSTR" ||
