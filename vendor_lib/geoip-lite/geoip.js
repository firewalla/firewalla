...
module.exports = {
    ...
    reloadDataSync: function (type) {
        switch (type) {
            case "ipv4": preload(); break;
            case "ipv6": preload6(); break;
            default: preload(); preload6(); break;
        }
    },
    ...
    // Dynamic update geodatadir
    updateGeodatadir: function (dir) {
        dataFiles = {
            city: path.join(dir, 'geoip-city.dat'),
            city6: path.join(dir, 'geoip-city6.dat'),
            cityNames: path.join(dir, 'geoip-city-names.dat'),
            country: path.join(dir, 'geoip-country.dat'),
            country6: path.join(dir, 'geoip-country6.dat')
        };
    }
};
try {
